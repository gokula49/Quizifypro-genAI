...
st.title(":blue[TwinSaiTech - QuizifyPro]  :red[Transform Your YouTube Videos into Interactive Quizzes to test your skills!]", anchor=False)
...
with st.form("user_input"):
    ...
    submitted = st.form_submit_button("Test Your Skills")
...
if submitted or ('quiz_data_list' in st.session_state):
    ...
    with st.spinner("Generating your quiz...🤓"):
        if submitted:
            ...
            quiz_data_str = get_quiz_data(video_transcription, 'your open AI key')
        ...
        with st.form(key='quiz_form'):
            st.subheader("TwinSaiTech : Test Your Knowledge!", anchor=False)
            ...
            results_submitted = st.form_submit_button(label='Your Score')
